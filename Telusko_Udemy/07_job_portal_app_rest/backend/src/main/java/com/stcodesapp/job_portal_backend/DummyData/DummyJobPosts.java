package com.stcodesapp.job_portal_backend.DummyData;
...
public class DummyJobPosts {

    public static ArrayList<JobPost> jobs = new ArrayList<>();

    static {
        initJobPosts();
    }

    public static void initJobPosts() {
